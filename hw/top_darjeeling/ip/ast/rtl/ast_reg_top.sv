...
module ast_reg_top (
  ...
  always_comb begin
    ...
    unique case (reg_addr)
      ...
      AST_REGAL_OFFSET: begin addr_valid = 1; addr_idx = 30; end
      AST_REGB_0_OFFSET: begin addr_valid = 1; addr_idx = 31; end
      AST_REGB_1_OFFSET: begin addr_valid = 1; addr_idx = 32; end
      AST_REGB_2_OFFSET: begin addr_valid = 1; addr_idx = 33; end
      AST_REGB_3_OFFSET: begin addr_valid = 1; addr_idx = 34; end
      AST_REGB_4_OFFSET: begin addr_valid = 1; addr_idx = 35; end
  ...
  assign regal_we = addr_valid & (addr_idx == 30) & reg_we & !reg_error;

  assign regal_wd = reg_wdata[31:0];

  assign regb_0_we = addr_valid & (addr_idx == 31) & reg_we & !reg_error;

  assign regb_0_wd = reg_wdata[31:0];

  assign regb_1_we = addr_valid & (addr_idx == 32) & reg_we & !reg_error;

  assign regb_1_wd = reg_wdata[31:0];

  assign regb_2_we = addr_valid & (addr_idx == 33) & reg_we & !reg_error;

  assign regb_2_wd = reg_wdata[31:0];

  assign regb_3_we = addr_valid & (addr_idx == 34) & reg_we & !reg_error;

  assign regb_3_wd = reg_wdata[31:0];

  assign regb_4_we = addr_valid & (addr_idx == 35) & reg_we & !reg_error;
