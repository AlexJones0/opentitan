...
module keymgr_dpe_reg_top (
  ...
  // To HW
  output keymgr_dpe_reg_pkg::keymgr_dpe_reg2hw_t reg2hw, // Write
  input  keymgr_dpe_reg_pkg::keymgr_dpe_hw2reg_t hw2reg, // Read
  ...
  logic max_key_ver_shadowed_re;
  logic max_key_ver_shadowed_we;
  logic [31:0] max_key_ver_shadowed_qs;
  logic [31:0] max_key_ver_shadowed_wd;
  logic max_key_ver_shadowed_storage_err;
  logic max_key_ver_shadowed_update_err;
  ...
  prim_subreg_shadow #(
    ...
    .re     (control_shadowed_re),
    .we     (control_shadowed_gated_we),
    .wd     (control_shadowed_slot_src_sel_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.control_shadowed.slot_src_sel.q),
    .ds     (),

    // to register interface (read)
    .qs     (control_shadowed_slot_src_sel_qs),

    // Shadow register phase. Relevant for hwext only.
    .phase  (),

    // Shadow register error conditions
    .err_update  (control_shadowed_slot_src_sel_update_err),
  ...
  prim_subreg_shadow #(
    ...
    .re     (control_shadowed_re),
    .we     (control_shadowed_gated_we),
    .wd     (control_shadowed_slot_dst_sel_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.control_shadowed.slot_dst_sel.q),
    .ds     (),

    // to register interface (read)
    .qs     (control_shadowed_slot_dst_sel_qs),
  ...
  // R[slot_policy_regwen]: V(True)
  logic slot_policy_regwen_qe;
  logic [0:0] slot_policy_regwen_flds_we;
  assign slot_policy_regwen_qe = &slot_policy_regwen_flds_we;
  prim_subreg_ext #(
    .DW    (1)
  ) u_slot_policy_regwen (
    .re     (slot_policy_regwen_re),
    .we     (slot_policy_regwen_we),
    .wd     (slot_policy_regwen_wd),
    .d      (hw2reg.slot_policy_regwen.d),
    .qre    (),
    .qe     (slot_policy_regwen_flds_we[0]),
    .q      (reg2hw.slot_policy_regwen.q),
    .ds     (),
    .qs     (slot_policy_regwen_qs)
  );
  assign reg2hw.slot_policy_regwen.qe = slot_policy_regwen_qe;


  // R[slot_policy]: V(False)
  // Create REGWEN-gated WE signal
  ...
  prim_subreg #(
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.slot_policy.allow_child.q),
    .ds     (),
  ...
  // Create REGWEN-gated WE signal
  logic sw_binding_0_gated_we;
  assign sw_binding_0_gated_we = sw_binding_0_we & sw_binding_regwen_qs;
  prim_subreg #(
    .DW      (32),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (32'h0),
  ...
  // Create REGWEN-gated WE signal
  logic sw_binding_1_gated_we;
  assign sw_binding_1_gated_we = sw_binding_1_we & sw_binding_regwen_qs;
  prim_subreg #(
    .DW      (32),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (32'h0),
  ...
  // Create REGWEN-gated WE signal
  logic sw_binding_2_gated_we;
  assign sw_binding_2_gated_we = sw_binding_2_we & sw_binding_regwen_qs;
  prim_subreg #(
    .DW      (32),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (32'h0),
  ...
  // Create REGWEN-gated WE signal
  logic sw_binding_3_gated_we;
  assign sw_binding_3_gated_we = sw_binding_3_we & sw_binding_regwen_qs;
  prim_subreg #(
    .DW      (32),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (32'h0),
  ...
  // Create REGWEN-gated WE signal
  logic sw_binding_4_gated_we;
  assign sw_binding_4_gated_we = sw_binding_4_we & sw_binding_regwen_qs;
  prim_subreg #(
    .DW      (32),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (32'h0),
  ...
  // Create REGWEN-gated WE signal
  logic sw_binding_5_gated_we;
  assign sw_binding_5_gated_we = sw_binding_5_we & sw_binding_regwen_qs;
  prim_subreg #(
    .DW      (32),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (32'h0),
  ...
  // Create REGWEN-gated WE signal
  logic sw_binding_6_gated_we;
  assign sw_binding_6_gated_we = sw_binding_6_we & sw_binding_regwen_qs;
  prim_subreg #(
    .DW      (32),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (32'h0),
  ...
  // Create REGWEN-gated WE signal
  logic sw_binding_7_gated_we;
  assign sw_binding_7_gated_we = sw_binding_7_we & sw_binding_regwen_qs;
  prim_subreg #(
    .DW      (32),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (32'h0),
  ...
  // Create REGWEN-gated WE signal
  logic max_key_ver_shadowed_gated_we;
  assign max_key_ver_shadowed_gated_we = max_key_ver_shadowed_we & max_key_ver_regwen_qs;
  prim_subreg_shadow #(
    .DW      (32),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (32'h0),
    .Mubi    (1'b0)
  ) u_max_key_ver_shadowed (
    .clk_i   (clk_i),
    .rst_ni  (rst_ni),
    .rst_shadowed_ni (rst_shadowed_ni),

    // from register interface
    .re     (max_key_ver_shadowed_re),
    .we     (max_key_ver_shadowed_gated_we),
    .wd     (max_key_ver_shadowed_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.max_key_ver_shadowed.q),
    .ds     (),

    // to register interface (read)
    .qs     (max_key_ver_shadowed_qs),

    // Shadow register phase. Relevant for hwext only.
    .phase  (),

    // Shadow register error conditions
    .err_update  (max_key_ver_shadowed_update_err),
    .err_storage (max_key_ver_shadowed_storage_err)
  );
  ...
  always_comb begin
    ...
    unique case (reg_addr)
      ...
      KEYMGR_DPE_INTR_STATE_OFFSET: begin addr_valid = 1; addr_idx = 0; end
      KEYMGR_DPE_INTR_ENABLE_OFFSET: begin addr_valid = 1; addr_idx = 1; end
      KEYMGR_DPE_INTR_TEST_OFFSET: begin addr_valid = 1; addr_idx = 2; end
      KEYMGR_DPE_ALERT_TEST_OFFSET: begin addr_valid = 1; addr_idx = 3; end
      KEYMGR_DPE_CFG_REGWEN_OFFSET: begin addr_valid = 1; addr_idx = 4; end
      KEYMGR_DPE_START_OFFSET: begin addr_valid = 1; addr_idx = 5; end
      KEYMGR_DPE_CONTROL_SHADOWED_OFFSET: begin addr_valid = 1; addr_idx = 6; end
      KEYMGR_DPE_SIDELOAD_CLEAR_OFFSET: begin addr_valid = 1; addr_idx = 7; end
      KEYMGR_DPE_RESEED_INTERVAL_REGWEN_OFFSET: begin addr_valid = 1; addr_idx = 8; end
      KEYMGR_DPE_RESEED_INTERVAL_SHADOWED_OFFSET: begin addr_valid = 1; addr_idx = 9; end
      KEYMGR_DPE_SLOT_POLICY_REGWEN_OFFSET: begin addr_valid = 1; addr_idx = 10; end
      KEYMGR_DPE_SLOT_POLICY_OFFSET: begin addr_valid = 1; addr_idx = 11; end
      KEYMGR_DPE_SW_BINDING_REGWEN_OFFSET: begin addr_valid = 1; addr_idx = 12; end
      KEYMGR_DPE_SW_BINDING_0_OFFSET: begin addr_valid = 1; addr_idx = 13; end
      KEYMGR_DPE_SW_BINDING_1_OFFSET: begin addr_valid = 1; addr_idx = 14; end
      KEYMGR_DPE_SW_BINDING_2_OFFSET: begin addr_valid = 1; addr_idx = 15; end
      KEYMGR_DPE_SW_BINDING_3_OFFSET: begin addr_valid = 1; addr_idx = 16; end
      KEYMGR_DPE_SW_BINDING_4_OFFSET: begin addr_valid = 1; addr_idx = 17; end
      KEYMGR_DPE_SW_BINDING_5_OFFSET: begin addr_valid = 1; addr_idx = 18; end
      KEYMGR_DPE_SW_BINDING_6_OFFSET: begin addr_valid = 1; addr_idx = 19; end
      KEYMGR_DPE_SW_BINDING_7_OFFSET: begin addr_valid = 1; addr_idx = 20; end
      KEYMGR_DPE_SALT_0_OFFSET: begin addr_valid = 1; addr_idx = 21; end
      KEYMGR_DPE_SALT_1_OFFSET: begin addr_valid = 1; addr_idx = 22; end
      KEYMGR_DPE_SALT_2_OFFSET: begin addr_valid = 1; addr_idx = 23; end
      KEYMGR_DPE_SALT_3_OFFSET: begin addr_valid = 1; addr_idx = 24; end
      KEYMGR_DPE_SALT_4_OFFSET: begin addr_valid = 1; addr_idx = 25; end
      KEYMGR_DPE_SALT_5_OFFSET: begin addr_valid = 1; addr_idx = 26; end
      KEYMGR_DPE_SALT_6_OFFSET: begin addr_valid = 1; addr_idx = 27; end
      KEYMGR_DPE_SALT_7_OFFSET: begin addr_valid = 1; addr_idx = 28; end
      KEYMGR_DPE_KEY_VERSION_OFFSET: begin addr_valid = 1; addr_idx = 29; end
      KEYMGR_DPE_MAX_KEY_VER_REGWEN_OFFSET: begin addr_valid = 1; addr_idx = 30; end
      KEYMGR_DPE_MAX_KEY_VER_SHADOWED_OFFSET: begin addr_valid = 1; addr_idx = 31; end
      KEYMGR_DPE_SW_SHARE0_OUTPUT_0_OFFSET: begin addr_valid = 1; addr_idx = 32; end
      KEYMGR_DPE_SW_SHARE0_OUTPUT_1_OFFSET: begin addr_valid = 1; addr_idx = 33; end
      KEYMGR_DPE_SW_SHARE0_OUTPUT_2_OFFSET: begin addr_valid = 1; addr_idx = 34; end
      KEYMGR_DPE_SW_SHARE0_OUTPUT_3_OFFSET: begin addr_valid = 1; addr_idx = 35; end
      KEYMGR_DPE_SW_SHARE0_OUTPUT_4_OFFSET: begin addr_valid = 1; addr_idx = 36; end
      KEYMGR_DPE_SW_SHARE0_OUTPUT_5_OFFSET: begin addr_valid = 1; addr_idx = 37; end
      KEYMGR_DPE_SW_SHARE0_OUTPUT_6_OFFSET: begin addr_valid = 1; addr_idx = 38; end
      KEYMGR_DPE_SW_SHARE0_OUTPUT_7_OFFSET: begin addr_valid = 1; addr_idx = 39; end
      KEYMGR_DPE_SW_SHARE1_OUTPUT_0_OFFSET: begin addr_valid = 1; addr_idx = 40; end
      KEYMGR_DPE_SW_SHARE1_OUTPUT_1_OFFSET: begin addr_valid = 1; addr_idx = 41; end
      KEYMGR_DPE_SW_SHARE1_OUTPUT_2_OFFSET: begin addr_valid = 1; addr_idx = 42; end
      KEYMGR_DPE_SW_SHARE1_OUTPUT_3_OFFSET: begin addr_valid = 1; addr_idx = 43; end
      KEYMGR_DPE_SW_SHARE1_OUTPUT_4_OFFSET: begin addr_valid = 1; addr_idx = 44; end
      KEYMGR_DPE_SW_SHARE1_OUTPUT_5_OFFSET: begin addr_valid = 1; addr_idx = 45; end
      KEYMGR_DPE_SW_SHARE1_OUTPUT_6_OFFSET: begin addr_valid = 1; addr_idx = 46; end
      KEYMGR_DPE_SW_SHARE1_OUTPUT_7_OFFSET: begin addr_valid = 1; addr_idx = 47; end
      KEYMGR_DPE_WORKING_STATE_OFFSET: begin addr_valid = 1; addr_idx = 48; end
      KEYMGR_DPE_OP_STATUS_OFFSET: begin addr_valid = 1; addr_idx = 49; end
      KEYMGR_DPE_ERR_CODE_OFFSET: begin addr_valid = 1; addr_idx = 50; end
      KEYMGR_DPE_FAULT_STATUS_OFFSET: begin addr_valid = 1; addr_idx = 51; end
      KEYMGR_DPE_DEBUG_OFFSET: begin addr_valid = 1; addr_idx = 52; end
      KEYMGR_DPE_LOAD_KEY_LOCK_OFFSET: begin addr_valid = 1; addr_idx = 53; end
  ...
  always_comb begin
    ...
    if (reg_we && addr_valid) begin
      case (addr_idx)
        // TODO: use the register index enum entries instead?
        0:  wr_err = |(KEYMGR_DPE_PERMIT[ 0] & ~reg_be);
        1:  wr_err = |(KEYMGR_DPE_PERMIT[ 1] & ~reg_be);
        2:  wr_err = |(KEYMGR_DPE_PERMIT[ 2] & ~reg_be);
        3:  wr_err = |(KEYMGR_DPE_PERMIT[ 3] & ~reg_be);
        4:  wr_err = |(KEYMGR_DPE_PERMIT[ 4] & ~reg_be);
        5:  wr_err = |(KEYMGR_DPE_PERMIT[ 5] & ~reg_be);
        6:  wr_err = |(KEYMGR_DPE_PERMIT[ 6] & ~reg_be);
        7:  wr_err = |(KEYMGR_DPE_PERMIT[ 7] & ~reg_be);
        8:  wr_err = |(KEYMGR_DPE_PERMIT[ 8] & ~reg_be);
        9:  wr_err = |(KEYMGR_DPE_PERMIT[ 9] & ~reg_be);
        10: wr_err = |(KEYMGR_DPE_PERMIT[10] & ~reg_be);
        11: wr_err = |(KEYMGR_DPE_PERMIT[11] & ~reg_be);
        12: wr_err = |(KEYMGR_DPE_PERMIT[12] & ~reg_be);
        13: wr_err = |(KEYMGR_DPE_PERMIT[13] & ~reg_be);
        14: wr_err = |(KEYMGR_DPE_PERMIT[14] & ~reg_be);
        15: wr_err = |(KEYMGR_DPE_PERMIT[15] & ~reg_be);
        16: wr_err = |(KEYMGR_DPE_PERMIT[16] & ~reg_be);
        17: wr_err = |(KEYMGR_DPE_PERMIT[17] & ~reg_be);
        18: wr_err = |(KEYMGR_DPE_PERMIT[18] & ~reg_be);
        19: wr_err = |(KEYMGR_DPE_PERMIT[19] & ~reg_be);
        20: wr_err = |(KEYMGR_DPE_PERMIT[20] & ~reg_be);
        21: wr_err = |(KEYMGR_DPE_PERMIT[21] & ~reg_be);
        22: wr_err = |(KEYMGR_DPE_PERMIT[22] & ~reg_be);
        23: wr_err = |(KEYMGR_DPE_PERMIT[23] & ~reg_be);
        24: wr_err = |(KEYMGR_DPE_PERMIT[24] & ~reg_be);
        25: wr_err = |(KEYMGR_DPE_PERMIT[25] & ~reg_be);
        26: wr_err = |(KEYMGR_DPE_PERMIT[26] & ~reg_be);
        27: wr_err = |(KEYMGR_DPE_PERMIT[27] & ~reg_be);
        28: wr_err = |(KEYMGR_DPE_PERMIT[28] & ~reg_be);
        29: wr_err = |(KEYMGR_DPE_PERMIT[29] & ~reg_be);
        30: wr_err = |(KEYMGR_DPE_PERMIT[30] & ~reg_be);
        31: wr_err = |(KEYMGR_DPE_PERMIT[31] & ~reg_be);
        32: wr_err = |(KEYMGR_DPE_PERMIT[32] & ~reg_be);
        33: wr_err = |(KEYMGR_DPE_PERMIT[33] & ~reg_be);
        34: wr_err = |(KEYMGR_DPE_PERMIT[34] & ~reg_be);
        35: wr_err = |(KEYMGR_DPE_PERMIT[35] & ~reg_be);
        36: wr_err = |(KEYMGR_DPE_PERMIT[36] & ~reg_be);
        37: wr_err = |(KEYMGR_DPE_PERMIT[37] & ~reg_be);
        38: wr_err = |(KEYMGR_DPE_PERMIT[38] & ~reg_be);
        39: wr_err = |(KEYMGR_DPE_PERMIT[39] & ~reg_be);
        40: wr_err = |(KEYMGR_DPE_PERMIT[40] & ~reg_be);
        41: wr_err = |(KEYMGR_DPE_PERMIT[41] & ~reg_be);
        42: wr_err = |(KEYMGR_DPE_PERMIT[42] & ~reg_be);
        43: wr_err = |(KEYMGR_DPE_PERMIT[43] & ~reg_be);
        44: wr_err = |(KEYMGR_DPE_PERMIT[44] & ~reg_be);
        45: wr_err = |(KEYMGR_DPE_PERMIT[45] & ~reg_be);
        46: wr_err = |(KEYMGR_DPE_PERMIT[46] & ~reg_be);
        47: wr_err = |(KEYMGR_DPE_PERMIT[47] & ~reg_be);
        48: wr_err = |(KEYMGR_DPE_PERMIT[48] & ~reg_be);
        49: wr_err = |(KEYMGR_DPE_PERMIT[49] & ~reg_be);
        50: wr_err = |(KEYMGR_DPE_PERMIT[50] & ~reg_be);
        51: wr_err = |(KEYMGR_DPE_PERMIT[51] & ~reg_be);
        52: wr_err = |(KEYMGR_DPE_PERMIT[52] & ~reg_be);
        53: wr_err = |(KEYMGR_DPE_PERMIT[53] & ~reg_be);
      endcase
    end
  end
  ...
  assign cfg_regwen_re = addr_valid & (addr_idx == 4) & reg_re & !reg_error;

  assign start_we = addr_valid & (addr_idx == 5) & reg_we & !reg_error;

  assign start_wd = reg_wdata[0];

  assign control_shadowed_re = addr_valid & (addr_idx == 6) & reg_re & !reg_error;
  assign control_shadowed_we = addr_valid & (addr_idx == 6) & reg_we & !reg_error;
  ...
  assign sideload_clear_we = addr_valid & (addr_idx == 7) & reg_we & !reg_error;

  assign sideload_clear_wd = reg_wdata[2:0];

  assign reseed_interval_regwen_we = addr_valid & (addr_idx == 8) & reg_we & !reg_error;

  assign reseed_interval_regwen_wd = reg_wdata[0];

  assign reseed_interval_shadowed_re = addr_valid & (addr_idx == 9) & reg_re & !reg_error;
  assign reseed_interval_shadowed_we = addr_valid & (addr_idx == 9) & reg_we & !reg_error;

  assign reseed_interval_shadowed_wd = reg_wdata[15:0];

  assign slot_policy_regwen_re = addr_valid & (addr_idx == 10) & reg_re & !reg_error;
  assign slot_policy_regwen_we = addr_valid & (addr_idx == 10) & reg_we & !reg_error;

  assign slot_policy_regwen_wd = reg_wdata[0];

  assign slot_policy_we = addr_valid & (addr_idx == 11) & reg_we & !reg_error;
  ...
  assign sw_binding_regwen_re = addr_valid & (addr_idx == 12) & reg_re & !reg_error;
  assign sw_binding_regwen_we = addr_valid & (addr_idx == 12) & reg_we & !reg_error;

  assign sw_binding_regwen_wd = reg_wdata[0];

  assign sw_binding_0_we = addr_valid & (addr_idx == 13) & reg_we & !reg_error;

  assign sw_binding_0_wd = reg_wdata[31:0];

  assign sw_binding_1_we = addr_valid & (addr_idx == 14) & reg_we & !reg_error;

  assign sw_binding_1_wd = reg_wdata[31:0];

  assign sw_binding_2_we = addr_valid & (addr_idx == 15) & reg_we & !reg_error;

  assign sw_binding_2_wd = reg_wdata[31:0];

  assign sw_binding_3_we = addr_valid & (addr_idx == 16) & reg_we & !reg_error;

  assign sw_binding_3_wd = reg_wdata[31:0];

  assign sw_binding_4_we = addr_valid & (addr_idx == 17) & reg_we & !reg_error;

  assign sw_binding_4_wd = reg_wdata[31:0];

  assign sw_binding_5_we = addr_valid & (addr_idx == 18) & reg_we & !reg_error;

  assign sw_binding_5_wd = reg_wdata[31:0];

  assign sw_binding_6_we = addr_valid & (addr_idx == 19) & reg_we & !reg_error;

  assign sw_binding_6_wd = reg_wdata[31:0];

  assign sw_binding_7_we = addr_valid & (addr_idx == 20) & reg_we & !reg_error;

  assign sw_binding_7_wd = reg_wdata[31:0];

  assign salt_0_we = addr_valid & (addr_idx == 21) & reg_we & !reg_error;

  assign salt_0_wd = reg_wdata[31:0];

  assign salt_1_we = addr_valid & (addr_idx == 22) & reg_we & !reg_error;

  assign salt_1_wd = reg_wdata[31:0];

  assign salt_2_we = addr_valid & (addr_idx == 23) & reg_we & !reg_error;

  assign salt_2_wd = reg_wdata[31:0];

  assign salt_3_we = addr_valid & (addr_idx == 24) & reg_we & !reg_error;

  assign salt_3_wd = reg_wdata[31:0];

  assign salt_4_we = addr_valid & (addr_idx == 25) & reg_we & !reg_error;

  assign salt_4_wd = reg_wdata[31:0];

  assign salt_5_we = addr_valid & (addr_idx == 26) & reg_we & !reg_error;

  assign salt_5_wd = reg_wdata[31:0];

  assign salt_6_we = addr_valid & (addr_idx == 27) & reg_we & !reg_error;

  assign salt_6_wd = reg_wdata[31:0];

  assign salt_7_we = addr_valid & (addr_idx == 28) & reg_we & !reg_error;

  assign salt_7_wd = reg_wdata[31:0];

  assign key_version_we = addr_valid & (addr_idx == 29) & reg_we & !reg_error;

  assign key_version_wd = reg_wdata[31:0];

  assign max_key_ver_regwen_re = addr_valid & (addr_idx == 30) & reg_re & !reg_error;
  assign max_key_ver_regwen_we = addr_valid & (addr_idx == 30) & reg_we & !reg_error;

  assign max_key_ver_regwen_wd = reg_wdata[0];

  assign max_key_ver_shadowed_re = addr_valid & (addr_idx == 31) & reg_re & !reg_error;
  assign max_key_ver_shadowed_we = addr_valid & (addr_idx == 31) & reg_we & !reg_error;

  assign max_key_ver_shadowed_wd = reg_wdata[31:0];

  assign sw_share0_output_0_re = addr_valid & (addr_idx == 32) & reg_re & !reg_error;

  assign sw_share0_output_0_wd = '1;

  assign sw_share0_output_1_re = addr_valid & (addr_idx == 33) & reg_re & !reg_error;

  assign sw_share0_output_1_wd = '1;

  assign sw_share0_output_2_re = addr_valid & (addr_idx == 34) & reg_re & !reg_error;

  assign sw_share0_output_2_wd = '1;

  assign sw_share0_output_3_re = addr_valid & (addr_idx == 35) & reg_re & !reg_error;

  assign sw_share0_output_3_wd = '1;

  assign sw_share0_output_4_re = addr_valid & (addr_idx == 36) & reg_re & !reg_error;

  assign sw_share0_output_4_wd = '1;

  assign sw_share0_output_5_re = addr_valid & (addr_idx == 37) & reg_re & !reg_error;

  assign sw_share0_output_5_wd = '1;

  assign sw_share0_output_6_re = addr_valid & (addr_idx == 38) & reg_re & !reg_error;

  assign sw_share0_output_6_wd = '1;

  assign sw_share0_output_7_re = addr_valid & (addr_idx == 39) & reg_re & !reg_error;

  assign sw_share0_output_7_wd = '1;

  assign sw_share1_output_0_re = addr_valid & (addr_idx == 40) & reg_re & !reg_error;

  assign sw_share1_output_0_wd = '1;

  assign sw_share1_output_1_re = addr_valid & (addr_idx == 41) & reg_re & !reg_error;

  assign sw_share1_output_1_wd = '1;

  assign sw_share1_output_2_re = addr_valid & (addr_idx == 42) & reg_re & !reg_error;

  assign sw_share1_output_2_wd = '1;

  assign sw_share1_output_3_re = addr_valid & (addr_idx == 43) & reg_re & !reg_error;

  assign sw_share1_output_3_wd = '1;

  assign sw_share1_output_4_re = addr_valid & (addr_idx == 44) & reg_re & !reg_error;

  assign sw_share1_output_4_wd = '1;

  assign sw_share1_output_5_re = addr_valid & (addr_idx == 45) & reg_re & !reg_error;

  assign sw_share1_output_5_wd = '1;

  assign sw_share1_output_6_re = addr_valid & (addr_idx == 46) & reg_re & !reg_error;

  assign sw_share1_output_6_wd = '1;

  assign sw_share1_output_7_re = addr_valid & (addr_idx == 47) & reg_re & !reg_error;

  assign sw_share1_output_7_wd = '1;


  assign op_status_we = addr_valid & (addr_idx == 49) & reg_we & !reg_error;

  assign op_status_wd = reg_wdata[1:0];

  assign err_code_we = addr_valid & (addr_idx == 50) & reg_we & !reg_error;
  ...
  assign debug_we = addr_valid & (addr_idx == 52) & reg_we & !reg_error;
  ...
  assign load_key_lock_we = addr_valid & (addr_idx == 53) & reg_we & !reg_error;
