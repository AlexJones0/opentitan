...
module clkmgr_reg_top (
  ...
  always_comb begin
    ...
    unique case (reg_addr)
      ...
      CLKMGR_IO_DIV4_MEAS_CTRL_EN_OFFSET: begin addr_valid = 1; addr_idx = 12; end
      CLKMGR_IO_DIV4_MEAS_CTRL_SHADOWED_OFFSET: begin addr_valid = 1; addr_idx = 13; end
      CLKMGR_MAIN_MEAS_CTRL_EN_OFFSET: begin addr_valid = 1; addr_idx = 14; end
      CLKMGR_MAIN_MEAS_CTRL_SHADOWED_OFFSET: begin addr_valid = 1; addr_idx = 15; end
      CLKMGR_USB_MEAS_CTRL_EN_OFFSET: begin addr_valid = 1; addr_idx = 16; end
      CLKMGR_USB_MEAS_CTRL_SHADOWED_OFFSET: begin addr_valid = 1; addr_idx = 17; end
      CLKMGR_RECOV_ERR_CODE_OFFSET: begin addr_valid = 1; addr_idx = 18; end
      CLKMGR_FATAL_ERR_CODE_OFFSET: begin addr_valid = 1; addr_idx = 19; end
  ...
  assign io_div4_meas_ctrl_en_we = addr_valid & (addr_idx == 12) & reg_we & !reg_error;


  assign io_div4_meas_ctrl_shadowed_re = addr_valid & (addr_idx == 13) & reg_re & !reg_error;
  assign io_div4_meas_ctrl_shadowed_we = addr_valid & (addr_idx == 13) & reg_we & !reg_error;


  assign main_meas_ctrl_en_we = addr_valid & (addr_idx == 14) & reg_we & !reg_error;


  assign main_meas_ctrl_shadowed_re = addr_valid & (addr_idx == 15) & reg_re & !reg_error;
  assign main_meas_ctrl_shadowed_we = addr_valid & (addr_idx == 15) & reg_we & !reg_error;


  assign usb_meas_ctrl_en_we = addr_valid & (addr_idx == 16) & reg_we & !reg_error;


  assign usb_meas_ctrl_shadowed_re = addr_valid & (addr_idx == 17) & reg_re & !reg_error;
  assign usb_meas_ctrl_shadowed_we = addr_valid & (addr_idx == 17) & reg_we & !reg_error;


  assign recov_err_code_we = addr_valid & (addr_idx == 18) & reg_we & !reg_error;
