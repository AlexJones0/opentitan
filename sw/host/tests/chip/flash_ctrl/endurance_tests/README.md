...
./bazelisk.sh run //sw/device/tests:flash_endurance_test_fpga_cw340_sival_rom_ext --test_arg=--command-file="$PWD/sw/host/tests/chip/flash_ctrl/endurance_tests/manual_example_phase_1.json" --test_arg=--log-file="/tmp/part_1_results.csv" --test_arg=--acknowledge-test-action

# ... do the manual baking here ...

# Run part 2 and log into part_2_results.csv
./bazelisk.sh run //sw/device/tests:flash_endurance_test_fpga_cw340_sival_rom_ext --test_arg=--command-file="$PWD/sw/host/tests/chip/flash_ctrl/endurance_tests/manual_example_phase_2.json" --test_arg=--log-file="/tmp/part_2_results.csv" --test_arg=--acknowledge-test-action
```
