...
use opentitanlib::test_utils::fpga_bkdr::{TargetWrite, verify_readback, write_to_target};
...
impl CommandDispatch for BkdrWrite {
    fn run(
        &self,
        context: &dyn Any,
        transport: &TransportWrapper,
...
impl CommandDispatch for BkdrVerify {
    fn run(
        &self,
        context: &dyn Any,
        transport: &TransportWrapper,
...
impl CommandDispatch for BkdrBatch {
    fn run(
        &self,
        context: &dyn Any,
        transport: &TransportWrapper,
