...
_FPGA_BITSTREAM = "sw/host/provisioning/orchestrator/src/test_bitstream.bit"
_FPGA_ROM = "sw/host/provisioning/orchestrator/src/test_rom.vmem"
_FPGA_OTP = "sw/host/provisioning/orchestrator/src/test_otp.vmem"
