...
use sphincsplus::{DecodeKey, SpxPublicKey, SpxSecretKey, SpxSignatureMode};
...
pub struct Import {
    ...
    #[arg(
        ...
        long,
        default_value = "None",
        help = "SPHINCS+ domain (if the backend requires the domain to be associated with the key)"
    )]
