...
<!-- TODO: is the requirement of hyperdebug for programming FPGA memories necessary? -->
...
bazel run //sw/host/opentitantool -- --interface=${INTERFACE} bkdr enter
# Load the ROM image
bazel run //sw/host/opentitantool -- --interface=${INTERFACE} bkdr \
...
# TODO: FIXME, no splicing. Need to address the cache as well.
